...
# Input: 2 dimensions. Hidden layers: 16 neurons * 2 layers. Output: single output `u(x, y)`
dim = 2
...
# Build the PDE system and discretize it. Because this system is time-invariant, the result is an `OptimizationProblem`.
